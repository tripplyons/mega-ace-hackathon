...
def approval_program():
    ...
    set_params = pt.Seq([
        ...
        # set params
        pt.App.globalPut(pt.Bytes('expiry'), pt.Global.latest_timestamp() + pt.Btoi(pt.Txn.application_args[0])),
    ...
    exercise = pt.Seq([
        ...
        pt.InnerTxnBuilder.Begin(),
        pt.InnerTxnBuilder.SetField(pt.TxnField.type_enum, pt.TxnType.AssetTransfer),
        pt.InnerTxnBuilder.SetField(pt.TxnField.xfer_asset, pt.App.globalGet(pt.Bytes('asa'))),
        pt.InnerTxnBuilder.SetField(pt.TxnField.asset_amount, pt.Int(1)),
        pt.InnerTxnBuilder.SetField(pt.TxnField.asset_receiver, pt.App.globalGet(pt.Bytes('buyer'))),
        pt.InnerTxnBuilder.SetField(
            pt.TxnField.sender, pt.Global.current_application_address()
        ),
        pt.InnerTxnBuilder.SetField(pt.TxnField.fee, pt.Int(0)),
